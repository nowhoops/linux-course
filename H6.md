- Task from teacher (Karvinen,Linux-palvelimet)
...
Sites:
- Apache, 2025. [SSL/TLS Encryption Configuration Example](https://httpd.apache.org/docs/2.4/ssl/ssl_howto.html#configexample).  
- Let's Encrypt, 2025. [How It Works](https://letsencrypt.org/how-it-works/).  
- SSL Labs, 2025. [SSL Test for heema.fi](https://www.ssllabs.com/ssltest/analyze.html?d=heema.fi).  
- Tero Karvinen, n.d. [Linux Palvelimet](https://terokarvinen.com/linux-palvelimet/).  
